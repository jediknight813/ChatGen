...
def authorization_guard(function):
    ...
    def decorator(*args, **kwargs):
        ...
        g.user_data = validated_token["sub"]
...
def permissions_guard(required_permissions=None):
    def decorator(function):
        ...
        def wrapper():
            ...
            # Return user data along with the protected message
            protected_message = {
                "message": "Protected message. You have the required permissions.",
                "user_data": user_data,
            }
            return jsonify(protected_message)
